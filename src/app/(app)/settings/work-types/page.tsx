...
export default async function WorkTypesSettingsPage() {
  ...
  return (
    <Card className="p-6">
      <SettingsPanelHeader
        title="Client & Lead Work Types"
        description={
          <>
            The shared work type / service options used by both Client and Lead forms — a lead converting to a
            client carries the same value forward. The &ldquo;Other&rdquo; row always shows a free-text field when
            selected, no matter what it&rsquo;s renamed to.
          </>
        }
      />
      <NameListManager
