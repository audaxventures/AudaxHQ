  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute right-2 top-2.5 z-10 flex h-5 w-5 items-center justify-center rounded-full border border-navy-200 bg-cream-50 text-navy-600 shadow-sm transition-all hover:bg-white hover:text-navy-900 hover:shadow-md cursor-pointer"
      >
